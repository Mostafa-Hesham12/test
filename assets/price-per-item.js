  ...
  customElements.define(
    ...
    class PricePerItem extends HTMLElement {
      ...
      init () {
        ...
        this.variantIdChangedUnsubscriber = StoreTheme.pubsub.subscribe(
        ...
        this.updatePricePerItemUnsubscriber = StoreTheme.pubsub.subscribe(
          ...
          if (this.currentQtyForVolumePricing >= pair[0]) {
            ...
            pricePerItemsCurrent.forEach((pricePerItemCurrent) => {
              this.classList.contains('variant-item__price-per-item')
                ? (pricePerItemCurrent.innerHTML = StoreTheme.quickOrderListStrings.each.replace('[money]', pair[1]))
