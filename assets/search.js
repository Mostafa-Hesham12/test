class PredictiveSearch extends HTMLElement {
  constructor() {
    ...
    this.input.addEventListener('input', StoreTheme.utils.debounce(this.onChange.bind(this), 300));
  ...
  setupURL() {
    const url = new URL(`${window.shopUrl}${StoreTheme.routes.predictive_search_url}`);
  ...
  renderSearchResults(responseText) {
    const id = 'PredictiveSearchResults-' + StoreTheme.utils.getSectionId(this);
