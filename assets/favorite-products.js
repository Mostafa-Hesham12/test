if (!customElements.get('favorite-products')) {
  customElements.define(
    ...
    class FavoriteProducts extends HTMLElement {
      ...
      initProductSlider() {
        const additionModules = [ThemeCore.Swiper.EffectFade];
        const sliderOptions = {
          slidesPerView: 1,
          loop: false,
          threshold: 2,
        ...
        this.ProductSlider = new window.ThemeCore.Carousel(this.productWrapper, sliderOptions, additionModules);
      ...
      initMediaSlider() {
        ...
        this.MediaSlider = new window.ThemeCore.Carousel(this.mediaWrapper.querySelector('.swiper'), sliderOptions);
      ...
      initTestimonialSlider() {
        ...
        this.TestimonialSlider = new window.ThemeCore.Carousel(
